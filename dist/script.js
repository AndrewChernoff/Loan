...
/* harmony import */ var _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/slider/main_slider */ "./src/js/modules/slider/main_slider.js");
/* harmony import */ var _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/slider/mini_slider */ "./src/js/modules/slider/mini_slider.js");
...
var slider = new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_5__["default"]({
  container: '.page',
  btns: '.next'
});
slider.render();
var modilesPageslider = new _modules_slider_main_slider__WEBPACK_IMPORTED_MODULE_5__["default"]({
  container: '.moduleapp',
  btns: '.next'
});
modilesPageslider.render();
var miniSlider = new _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_6__["default"]({
...
miniSlider.init();
var video = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_4__["default"]('.play__circle', '.overlay', '.close');
video.render();
var videoModule = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_4__["default"]('.module__video .play__circle', '.overlay', '.close');
videoModule.render();
var moduleSlider = new _modules_slider_mini_slider__WEBPACK_IMPORTED_MODULE_6__["default"]({
...
feedSlider.init();
var education = new _modules_difference__WEBPACK_IMPORTED_MODULE_1__["default"]({
  container: '.officerold',
  items: '.officerold .officer__card-item',
  clickItem: '.plus'
});
education.init();
var educationPast = new _modules_difference__WEBPACK_IMPORTED_MODULE_1__["default"]({
  container: '.officernew',
  items: '.officernew .officer__card-item',
  clickItem: '.plus'
});
educationPast.init();
var form = new _modules_form__WEBPACK_IMPORTED_MODULE_3__["default"]({
  selector: '.form'
});
form.init();
var accordeon = new _modules_accordeon__WEBPACK_IMPORTED_MODULE_0__["default"]({
  clickSelector: '.plus__content'
});
accordeon.init();
var download = new _modules_download__WEBPACK_IMPORTED_MODULE_2__["default"]({
  triggers: '.download'
});
download.init();
...
function () {
  function Accordeon() {
    var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '',
        clickSelector = _ref.clickSelector;
    ...
    value: function init() {
      this.plus.forEach(function (el, i) {
        el.addEventListener('click', function () {
          var sibling = el.closest('.module__info-show').nextElementSibling;
...
function () {
  ...
  _createClass(Form, [{
    ...
    value: function maskNumber() {
      ...
      this.phone.forEach(function (input) {
    ...
    value: function init() {
      ...
      this.email.forEach(function (item) {
        item.addEventListener('input', function () {
          return item.value = item.value.replace(/[^a-z 1-9 @]/i, "");
        });
      });
      this.maskNumber();
      ...
      this.forms.forEach(function (item) {
        item.addEventListener('submit', function (e) {
          ...
          div.style.cssText = "\n                margin: 10px;\n                color: ".concat(color, ";\n                font-size: 25px;\n                font-weight: 900;\n                ");
          div.textContent = _this.messages.loading;
          ...
          _this.postData(obj).then(function (response) {
            div.textContent = _this.messages.success;
            ...
            div.textContent = _this.messages.error;
          }).finally(function () {
            setTimeout(function () {
              item.reset();
...
/*#__PURE__*/
function () {
  function playVideo(trigger, modal, close) {
  ...
  _createClass(playVideo, [{
    ...
    value: function onYouTubeIframeAPIReady(url) {
      /// youtube API
          ...
          btn.addEventListener('click', function () {
            if (btn.dataset.disabled != 'true') {
              ...
              if (document.querySelector('iframe#frame')) {
                ...
                if (_this.path != btn.parentNode.getAttribute('data-url')) {
                  _this.path = btn.parentNode.getAttribute('data-url');
                ...
                _this.onYouTubeIframeAPIReady(_this.path);
              }
            }
          });
        });
    ...
    value: function onPlayerStateChange(e) {
      try {
        var firstBtn = this.activeBtn;
        var blockedBtn = firstBtn.closest('.module__video-item').nextElementSibling;
...
/***/ "./src/js/modules/slider/main_slider.js":
/*!**********************************************!*\
  !*** ./src/js/modules/slider/main_slider.js ***!
  \**********************************************/
/*! exports provided: default */
...
function (_Slider) {
  ...
  _createClass(MainSlider, [{
    ...
    key: "movePage",
    value: function movePage(number) {
        ...
        if (this.container.className === 'moduleapp') {
          ...
          document.querySelectorAll('.prev').forEach(function (el) {
            return el.addEventListener('click', function () {
              ...
              console.log(_this2.slides.length);
...
/***/ "./src/js/modules/slider/mini_slider.js":
/*!**********************************************!*\
  !*** ./src/js/modules/slider/mini_slider.js ***!
  \**********************************************/
/*! exports provided: default */
...
function (_Slider) {
  ...
  function MiniSlider(container, nextBtn, prevBtn, slides, activeClassname, animated, interval) {
    var _this;

    _classCallCheck(this, MiniSlider);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(MiniSlider).call(this, container, nextBtn, prevBtn, slides, activeClassname, animated, interval));
    _this.tab = document.querySelector(".card");
    return _this;
  }

  _createClass(MiniSlider, [{
    key: "classManage",
    value: function classManage() {
      var _this2 = this;

      this.slides.forEach(function (slide) {
        slide.classList.remove(_this2.activeClassname);
      });
      ...
      this.prevBtn.addEventListener('click', function () {
        for (var i = _this3.slides.length - 1; i > 0; i--) {
          if (_this3.slides[i].tagName === 'BUTTON') {
            ...
            var _active = _this3.slides[0];

            _this3.container.appendChild(_active);
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : '',
      ...
      activeClassname = _ref$activeClassname === void 0 ? null : _ref$activeClassname,
